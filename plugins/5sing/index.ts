...
async function getArtistMusicWorks(artistItem, page) {
  ...
  if (!fcEnd) {
    const res = (
      await axios.get("http://service.5sing.kugou.com/user/songlist", {
        headers,
        params: {
...
async function getLyric(musicItem) {
  const res = (
    await axios.get("http://5sing.kugou.com/fm/m/json/lrc", {
      headers,
      params: {
        songId: musicItem.id,
...
async function getAlbumInfo(albumItem) {
  ...
  const res = (
    await axios.get("http://service.5sing.kugou.com/song/getPlayListSong", {
      headers: headers,
      params: {
        id: albumItem.id,
      },
...
module.exports = {
  platform: "5sing",
  version: "0.1.2",
  srcUrl: "https://mirror.ghproxy.com/https://raw.githubusercontent.com/FanchangWang/MusicFreePlugins/master/dist/5sing/index.js",
  ...
  async getMediaSource(musicItem, quality: IMusic.IQualityKey) {
    ...
    const res = (
      await axios.get("http://service.5sing.kugou.com/song/getsongurl", {
        headers,
        params: {
          songid: musicItem.id,
          songtype: musicItem.typeEname,
