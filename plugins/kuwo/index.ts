...
async function getRecommendSheetsByTag(tag, page) {
  ...
  if (tag.id) {
    if (tag.digest === "10000") {
      res = (
        await axios.get(
          `http://wapi.kuwo.cn/api/pc/classify/playlist/getTagPlayList?loginUid=0&loginSid=0&appUid=76039576&pn=${page - 1
    ...
    res = (
      await axios.get(
        `https://wapi.kuwo.cn/api/pc/classify/playlist/getRcmPlayList?loginUid=0&loginSid=0&appUid=76039576&&pn=${page - 1
...
module.exports = {
  ...
  srcUrl:
    "https://mirror.ghproxy.com/https://raw.githubusercontent.com/FanchangWang/MusicFreePlugins/master/dist/kuwo/index.js",
