...
async function getValidMusicItems(trackIds) {
  ...
  try {
    ...
    const songDetails = (
      await axios.get(
        `https://music.163.com/api/song/detail/?id=${validTrackIds[0]
...
module.exports = {
  ...
  srcUrl:
    "https://mirror.ghproxy.com/https://raw.githubusercontent.com/FanchangWang/MusicFreePlugins/master/dist/netease/index.js",
