...
async function getMediaSource(
  ...
  const info = (
    await axios.get(
      `https://www.ximalaya.com/mobile-playpage/track/v3/baseInfo/${Date.now()}?device=www&trackId=${musicItem.id
      }&trackQualityLevel=1`
    )
  ).data;
...
module.exports = {
  ...
  srcUrl:
    "https://mirror.ghproxy.com/https://raw.githubusercontent.com/FanchangWang/MusicFreePlugins/master/dist/xmly/index.js",
